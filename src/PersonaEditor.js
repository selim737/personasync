    ...
    <div className="p-4 space-y-6 max-w-6xl mx-auto">
      <Card>
        <CardContent className="p-4 grid grid-cols-1 md:grid-cols-2 gap-4">
          <Input placeholder="Name" value={persona.name} onChange={(e) => handleChange("name", e.target.value)} />
          ...
          <Input placeholder="Interests" value={persona.interests} onChange={(e) => handleChange("interests", e.target.value)} />
      ...
      <Card>
        <CardContent className="p-4 space-y-4">
          <Textarea placeholder="Description" value={persona.description} onChange={(e) => handleChange("description", e.target.value)} />
          ...
          <CustomFieldEditor
            ...
            setCustomFields={(newFields) => setPersona((prev) => ({ ...prev, custom_fields: newFields }))}
          />
        </CardContent>
      </Card>
      ...
      <Card>
        <CardContent className="p-4">
          ...
          <Textarea className="font-mono text-sm" rows={20} value={yamlOutput} readOnly />
        </CardContent>
      </Card>
    </div>
  );
